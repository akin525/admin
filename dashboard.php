...
?>
<?php
$result = mysqli_query($con,"SELECT count(*) FROM  users where allowpurchase=1");
$row = mysqli_fetch_row($result);
$numrows = $row[0];
            ...
            <div class="col-xl-3 col-xxl-6 col-sm-6">
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">NGN.<?php echo number_format(intval($total1 *1),2);?></h2>
                            <span class="text-white fs-18">Total Deposit</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-xxl-6 col-sm-6">
                <div class="card bg-success invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num"><?php echo "$numrows"; ?></h2>
            ...
            <div class="col-xl-3 col-xxl-6 col-sm-6">
                <div class="card bg-info invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">NGN.<?php echo number_format(intval($total *1),2);?></h2>
                            <span class="text-white fs-18">Total Users Wallet</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            curl_setopt_array($curl, array(
                                ...
                                CURLOPT_POSTFIELDS => array('api' => 'MCDKEY_903sfjfi0ad833mk8537dhc03kbs120r0h9a','service' => 'wallet','coded' => 'balance','phone' => '08146328645'),
                            ));
...
//                            echo $response;
                            ...
                            if($success==1){
                            ?>
                            <h2 class="text-white invoice-num">NGN.<?php echo $tran; ?></h2>
                            <span class="text-white fs-18">MCD Wallet</span>
                            <?php } ?>
                            <?php
                            if($success==0){
                            ?>
                            <h4 class="text-white fs-18">Check Your Connection</h4>
                            <span class="text-white fs-18">MCD Wallet</span>
                            <?php }?>
                        </div>
                    </div>
...
<!--                                        <h2 class="text-white card-balance">#.--><?php //echo number_format(intval($total *1),2);?><!--</h2>-->
                                    ...
                                    <table class="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                        ...
                                        while($row = mysqli_fetch_array($result)) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row["iwallet"] ; ?></td>
                                                <td><?php echo $row["fwallet"] ; ?></td>
                                                <!--        <td>--><?php //echo $row["amount"] ; ?><!--</td>-->

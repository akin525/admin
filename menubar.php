...
<!--                        </li>-->
                        <li class="nav-item">
                            <a href="logout.php" class="btn btn-primary d-sm-inline-block d-none">logout</a>
                        </li>
                    </ul>
                </div>
            </nav>
                    ...
                    <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                        ...
                        <div class="header-info ms-3">
                            ...
                            while($row = mysqli_fetch_array($result))
                            {
                                ...
                                $pa="$row[username]";}
                            if($pa==null){
                                echo "Please kindly relogin";
                            }
                            ?>
                            <span class="font-w600 ">Hi,<b><?php echo $pa; ?></b></span>
<!--                            <small class="text-end font-w400">--><?php //echo $user_check; ?><!--</small>-->
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
                ...
                <li><a href="services.php" aria-expanded="false">
                        <i class="flaticon-025-dashboard"></i>
                        <span class="nav-text">Service Status</span>
                    </a>
                </li>
                ...
                <li><a href="slider%20message.php" aria-expanded="false">
                        <i class="flaticon-025-dashboard"></i>
                        <span class="nav-text">Slide M</span>
                    </a>
                </li>
                <li><a  href="manage.php" aria-expanded="false">
                        <i class="flaticon-044-menu"></i>
                        <span class="nav-text">Manage Deposit</span>
                    </a>
                <li><a  href="gateway.php" aria-expanded="false">
                        <i class="flaticon-044-menu"></i>
                        <span class="nav-text">Gateway</span>
                    </a>
                </li>
                <li><a  href="product.php" aria-expanded="false">
                        <i class="flaticon-044-menu"></i>
                        <span class="nav-text">Product</span>
                    </a>
                </li><li><a  href="createp.php" aria-expanded="false">
                        <i class="flaticon-044-menu"></i>
                        <span class="nav-text">Create Product</span>
                    </a>
                </li>

                <li><a  href="chargeuser.php" aria-expanded="false">
                        <i class="flaticon-044-menu"></i>
                        <span class="nav-text">Charge User</span>
                    </a>
                </li>
                ...
                <li><a  href="credit.php" aria-expanded="false">
                        <i class="flaticon-044-menu"></i>
                        <span class="nav-text">Credit Users</span>
                    </a>
                </li>
                <li><a  href="viewdeposits.php" aria-expanded="false">
                        <i class="flaticon-044-menu"></i>
                        <span class="nav-text">Deposits</span>
                    </a>
                </li>
                <li><a  href="bill.php" aria-expanded="false">
                        <i class="flaticon-044-menu"></i>
            ...
            <div class="copyright">
                <p><strong>MCD Admin Dashboard</strong> © 2021 All Rights Reserved</p>
                <p class="fs-12"> <span class="heart"></span> </p>
            </div>
        </div>
    </div>